...
public class CellIndexMethod {
    ...
    public static HashMap<Integer, Set<Particle>> cellIndexMethod(List<Particle> particles, int L, int M, int W, double rc, boolean periodicGrid) {
        Grid grid = new Grid(particles, periodicGrid, M, L, W);
